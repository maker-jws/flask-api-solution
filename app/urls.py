...
api.add_resource(ActivityDetail, '/activity/<string:key>')
api.add_resource(ActivityUpdate, '/activity/<string:key>')
api.add_resource(ActivityDelete, '/activity/<string:key>')